...
export const SPONSORSHIP_PRODUCTS = Object.freeze({
  ...
  tool_page_30: {
    id: 'tool_page_30', placement: 'tool_page', durationDays: 30,
    amount: '49.00', label: 'Tool Page Sponsored — 30 days',
  },
  tool_page_90: {
    id: 'tool_page_90', placement: 'tool_page', durationDays: 90,
    amount: '129.00', label: 'Tool Page Sponsored — 90 days',
  },
  buyer_intent_7: {
    id: 'buyer_intent_7', placement: 'buyer_intent', durationDays: 7,
    amount: '39.00', label: 'Buyer-Intent Featured — 7 days',
  },
  buyer_intent_30: {
    id: 'buyer_intent_30', placement: 'buyer_intent', durationDays: 30,
    amount: '99.00', label: 'Buyer-Intent Featured — 30 days',
  },
  buyer_intent_90: {
    id: 'buyer_intent_90', placement: 'buyer_intent', durationDays: 90,
    amount: '269.00', label: 'Buyer-Intent Featured — 90 days',
  },
  comparison_7: {
    id: 'comparison_7', placement: 'comparison', durationDays: 7,
    amount: '59.00', label: 'Comparison Premium — 7 days',
  },
  comparison_30: {
    id: 'comparison_30', placement: 'comparison', durationDays: 30,
    amount: '149.00', label: 'Comparison Premium — 30 days',
  },
  comparison_90: {
    id: 'comparison_90', placement: 'comparison', durationDays: 90,
    amount: '399.00', label: 'Comparison Premium — 90 days',
  },
});
...
export function assertProductAmount(amount, productId = DEFAULT_PRODUCT_ID) {
...
// Legacy compatibility for code paths that still expect the original fixed $49 product.
