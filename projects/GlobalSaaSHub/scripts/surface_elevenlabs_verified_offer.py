...
required = [
    ...
    "$22/month",
    "$99/month",
    "test the voice workflow and credit consumption first",
    "Try ElevenLabs →",
]
...
print("Surfaced ElevenLabs buyer offer")
