...
def main() -> None:
    ...
    # it here with already-approved customer routes before Vite copies public/ into
    # dist. A normal idempotence exit is safe; any evidence/safety failure stops the
    # production build instead of publishing a guessed affiliate destination.
    for script_name in (
