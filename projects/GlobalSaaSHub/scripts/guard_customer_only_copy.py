...
EXACT = {
    ...
    "Attribution is ultimately controlled by Unbounce and the provider. COSHUMA does not claim a referral or commission until the partner system confirms it.": "Final eligibility and checkout pricing are controlled by Unbounce.",
