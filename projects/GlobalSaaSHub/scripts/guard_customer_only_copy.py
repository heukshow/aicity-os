...
EXACT = {
    ...
    "COSHUMA focuses on pricing, free access, buyer fit and verified partner routes without treating clicks as revenue.": "COSHUMA focuses on pricing, free access, buyer fit and practical product differences.",
    "A verified partner route is kept separate from editorial product fit, and publication or test clicks are not treated as signups, customers or revenue.": "Use the comparison to narrow your shortlist, then confirm current pricing and terms on the vendor's site before purchasing.",
    "Relevance AI buyer guide for AI agent teams: current product positioning, pricing reality, free entry path, enterprise controls, integrations, and a verified COSHUMA partner link.": "Relevance AI buyer guide for AI agent teams: current product positioning, pricing reality, free entry, enterprise controls, integrations and practical product-fit guidance.",
    "Decide whether Relevance AI fits your AI-agent workflow, then use COSHUMA's verified partner route or the official pricing page.": "Decide whether Relevance AI fits your AI-agent workflow, then compare the current free-entry and pricing options.",
    "Buyer guide verified against current official product and pricing pages · Sep 6, 2026": "Buyer guide based on current official product and pricing information · Sep 6, 2026",
    "Try Relevance AI via COSHUMA →": "Try Relevance AI →",
    "This makes the verified partner route suitable for visitors who want to test the platform before a paid decision.": "This makes it practical to test the platform before making a paid decision.",
    "Start with the verified partner route →": "Start free with Relevance AI →",
    "Use the verified COSHUMA partner route for the free-entry path, then confirm current plan availability and checkout terms directly with Relevance AI before upgrading.": "Start with the free-entry path, then confirm current plan availability and checkout terms directly with Relevance AI before upgrading.",
    ...
    "Unbounce pricing starts at $29/month. Compare current plans, the 14-day no-card trial, and COSHUMA's verified offer: 20% off 3 months or 35% off the first annual subscription.": "Unbounce pricing starts at $29/month. Compare current plans, the 14-day no-card trial, and the current offer: 20% off 3 months or 35% off the first annual subscription.",
    "Current Unbounce pricing, 14-day trial, plan-fit guidance, and COSHUMA's verified customer partner offer.": "Current Unbounce pricing, 14-day trial, plan-fit guidance and the current discount offer.",
    ...
    "Partner discount, commission and cookie details were checked against the Unbounce partner welcome email sent to COSHUMA on September 3, 2026.": "The current Unbounce discount was checked against vendor-supplied terms on September 3, 2026.",
    "Webflow vs Unbounce in 2026: compare current pricing, CMS/hosting vs landing-page optimization, A/B testing, AI features, and COSHUMA's verified Unbounce partner offer.": "Webflow vs Unbounce in 2026: compare current pricing, CMS/hosting vs landing-page optimization, A/B testing, AI features and the current Unbounce discount.",
    "Does COSHUMA have a verified Unbounce offer?": "What Unbounce discount is currently available?",
    "Yes. COSHUMA's verified Unbounce PartnerStack link is documented with a customer offer of 20% off the first three months or 35% off the first annual subscription. Final eligibility and checkout pricing are controlled by Unbounce.": "The current Unbounce offer provides 20% off the first three months or 35% off the first annual subscription for eligible customers. Final eligibility and checkout pricing are controlled by Unbounce.",
    "Start Unbounce trial + verified partner offer →": "Start Unbounce trial + discount →",
    "COSHUMA's verified Unbounce partner route documents 20% off the first 3 months or 35% off the first annual subscription. Final eligibility and checkout pricing are controlled by Unbounce.": "The current Unbounce offer provides 20% off the first 3 months or 35% off the first annual subscription for eligible customers. Final eligibility and checkout pricing are controlled by Unbounce.",
    "Build a page for an actual traffic source, measure editing speed and conversion workflow, and only keep the paid plan if the CRO features solve a real campaign bottleneck. COSHUMA keeps the revenue CTA on the exact verified PartnerStack customer link rather than a generic homepage.": "Build a page for an actual traffic source, measure editing speed and conversion workflow, and only keep the paid plan if the CRO features solve a real campaign bottleneck.",
    ...
    "Databox pricing and feature claims were rechecked against Databox's live pricing page on September 8, 2026. Brand24 prices, annual discounts and trial terms were rechecked against Brand24's live pricing page on September 8, 2026. The customer-facing Databox and Brand24 URLs used above are the account-specific links already marked verified in COSHUMA's affiliate state; generic dashboards or onboarding URLs are not used as revenue CTAs. Vendor pricing can change, so confirm checkout before paying.": "Databox pricing and feature claims were rechecked against Databox's live pricing page on September 8, 2026. Brand24 prices, annual discounts and trial terms were rechecked against Brand24's live pricing page on September 8, 2026. Vendor pricing can change, so confirm checkout before paying.",
    ...
    "Affiliate disclosure: the Brand24 buttons use COSHUMA's previously verified PartnerStack customer tracking URL. COSHUMA may earn a commission if an eligible buyer later becomes a paying customer. Mention stays non-affiliate here because no exact COSHUMA customer tracking URL has been verified. Publishing or clicking this page is not treated as a signup, paid customer, commission or revenue event.": "Affiliate disclosure: COSHUMA may earn a commission from eligible purchases made through the marked Brand24 links, at no extra cost to you.",
    "SaneBox pricing starts at $4.54/month on biyearly billing. Compare Snack, Lunch and Dinner, the standard 7-day public trial, and COSHUMA's verified SaneBox referral route.": "SaneBox pricing starts at $4.54/month on biyearly billing. Compare Snack, Lunch and Dinner, the standard 7-day public trial and the current longer-trial offer available from this page.",
    "Compare current SaneBox pricing, the standard public trial, and COSHUMA's verified customer referral route.": "Compare current SaneBox pricing, the standard public trial and the current longer-trial offer available from this page.",
    ...
    "Teachable's public pricing page currently shows a <strong class=\"text-white\">7-day free trial</strong>. Separately, Teachable affiliate manager Camila Gouveia supplied COSHUMA the exact PartnerStack URL below and described it as COSHUMA's <strong class=\"text-white\">30-day Free Trial</strong> route. That distinction matters: COSHUMA does not manufacture a longer-trial URL by adding parameters to Teachable's website.": "Teachable's public pricing page currently shows a <strong class=\"text-white\">7-day free trial</strong>. The offer linked from this page currently states a <strong class=\"text-white\">30-day free trial</strong>. Confirm the trial length and billing terms shown at the destination before signup.",
    "Open verified 30-day trial route →": "Check the 30-day trial offer →",
    "Affiliate disclosure: the first button uses the customer-facing PartnerStack route that Teachable supplied directly to COSHUMA. COSHUMA may earn a commission if an eligible paid customer is attributed through it, at no extra cost to the buyer. Link issuance does not prove a signup, sale or commission.": "Affiliate disclosure: COSHUMA may earn a commission from eligible purchases made through the marked Teachable link, at no extra cost to you.",
    "COSHUMA vendor-supplied route": "Offer linked here",
    "You want a vendor-issued tracked route rather than a guessed coupon or URL parameter.": "You want enough time to test a representative course workflow before paying.",
    ...
    "Open the exact 30-day PartnerStack route below, confirm the offer shown at the destination, and use the trial to validate your real course or digital-product workflow. For a broader feature breakdown, read COSHUMA's Teachable pricing guide first.": "Open the 30-day trial offer below, confirm the terms shown at the destination, and use the trial to validate your real course or digital-product workflow. For a broader feature breakdown, read COSHUMA's Teachable pricing guide first.",
    "Start through verified 30-day route →": "Start the 30-day trial →",
    "Teachable's official pricing page for current plan prices, public 7-day trial, 30-day guarantee and transaction-fee terms; Teachable's direct PartnerStack message to COSHUMA for the exact 30-day Free Trial customer route. Last checked September 15, 2026.": "Teachable's official pricing page and current trial offer were checked for plan prices, trial terms, guarantee and transaction-fee details. Last checked September 15, 2026.",
    ...
    "A buyer-focused comparison of Moosend and Mailchimp's current free-entry options, with COSHUMA's verified Moosend partner route.": "A buyer-focused comparison of Moosend and Mailchimp's current free-entry options.",
    "COSHUMA uses its verified account-specific partner URL for Moosend. Mailchimp links on this page are official non-affiliate reference links.": "COSHUMA may earn a commission from eligible purchases made through the marked Moosend links. Mailchimp links on this page go to the official vendor site.",
    "Verified COSHUMA partner route. COSHUMA may earn a commission on a qualifying purchase.": "Affiliate disclosure: COSHUMA may earn a commission from an eligible Moosend purchase, at no extra cost to you.",
    "Official Mailchimp link. COSHUMA has not verified a commission-bearing Mailchimp customer route, so no affiliate URL is invented here.": "Official Mailchimp link.",
    ...
    "COSHUMA has an exact, account-specific Moosend PartnerStack customer URL that has been verified. No commission-bearing Mailchimp customer URL has been verified for COSHUMA, so Mailchimp remains official-only on this page.": "The Moosend links are marked because COSHUMA may earn a commission from eligible purchases. Mailchimp links on this page go directly to the official vendor site.",
    "Start Moosend free through COSHUMA →": "Start Moosend free →",
    "Affiliate disclosure: COSHUMA may earn a commission from qualifying Moosend purchases through the marked partner links. Mailchimp references are non-affiliate.": "Affiliate disclosure: COSHUMA may earn a commission from eligible purchases made through the marked Moosend links, at no extra cost to you.",
    ...
    "Affiliate disclosure: COSHUMA may earn a commission if you purchase through a verified Claap affiliate link, at no extra cost to you. This does not affect our editorial assessment.": "Affiliate disclosure: COSHUMA may earn a commission from eligible purchases made through the marked Claap link, at no extra cost to you.",
    "this review uses Claap's current official product/security pages plus direct feedback from Claap affiliate manager Lamia Karmaly. COSHUMA does not claim hands-on testing where none was performed. Final plan limits and pricing are controlled by Claap.": "this review uses Claap's current official product and security information. COSHUMA does not claim hands-on testing where none was performed. Final plan limits and pricing are controlled by Claap.",
...
UNBOUNCE_COOKIE_FAQ = re.compile(r',\s*\{\s*"@type":\s*"Question",\s*"name":\s*"How long does the Unbounce partner cookie last\?",\s*"acceptedAnswer":\s*\{\s*"@type":\s*"Answer",\s*"text":\s*"Unbounce\'s partner welcome email states that COSHUMA\'s verified referral link uses a 90-day tracking cookie\."\s*\}\s*\}', re.S)
DOCSBOT_INTERNAL_SECTION = re.compile(r'<section\b[^>]*>\s*<h2\b[^>]*>Verified COSHUMA affiliate terms</h2>.*?</section>', re.I | re.S)
DOCSBOT_INTERNAL_NOTE = re.compile(r'<div\b[^>]*>Unique affiliate URL verified from DocsBot\'s partner welcome email to COSHUMA on September 1, 2026\.</div>', re.I | re.S)

INTERNAL_OPS_PATTERNS = [re.compile(p, re.I) for p in [
    r"^Affiliate status:", r"COSHUMA affiliate status", r"COSHUMA CTA state", r"PartnerStack application",
    r"authenticated partner[- ]dashboard", r"affiliate manager", r"partner welcome email", r"welcome email to COSHUMA",
    r"account-specific .* tracking URL", r"account-specific .* partner URL", r"customer tracking URL .* verified",
    r"customer-facing .* tracking URL", r"customer-facing .* PartnerStack", r"exact PartnerStack", r"verified PartnerStack",
    r"revenue[- ]truth", r"revenue CTA", r"tracking cookie", r"tracking verification", r"partner dashboard confirms",
    r"link issuance does not", r"publication .* not treated as .* revenue", r"no .* commission-bearing .* URL .* verified",
    r"COSHUMA has not (?:submitted|verified|received|recovered)", r"COSHUMA .* no approval .* tracking URL",
    r"official non-affiliate link", r"buttons .* remain official non-affiliate", r"generic .* dashboard .* revenue",
    r"exact customer link rather than", r"first-party reporting verifies it", r"authenticated ClickFunnels Affiliate Center",
]]
TAG_RE = re.compile(r"<[^>]+>")
        ...
        def walk(node):
            ...
            if "FAQPage" in types and isinstance(node.get("mainEntity"), list):
                ...
                for item in node["mainEntity"]:
                    ...
                    admin = bool(re.search(r"COSHUMA.*(?:affiliate|partner|route|link)|affiliate link|referral link|tracking URL|PartnerStack", q, re.I))
                    if admin or internal_ops_text(f"{q} {a}"):
                        changed = True
                        continue
                    kept.append(item)
...
BANNED_CUSTOMER_COPY = re.compile(
    r'verified partner route|verified partner path|verified partner offer|verified partner link|Verified COSHUMA affiliate terms|'
    r'unique referral URL|partner welcome email|revenue CTA|verified CTA status|without treating clicks as revenue|tracking cookie|'
    r'first-party reporting verifies it|dashboard/login URL|account-specific links already marked verified|partner dashboard confirms it|'
    r'exact verified PartnerStack customer link|authenticated ClickFunnels Affiliate Center|Affiliate status:|COSHUMA verified revenue route|'
    r'exact PartnerStack customer URL verified|authenticated partner-dashboard|affiliate manager .* supplied COSHUMA|'
    r'COSHUMA has not verified an account-specific', re.I)
...
def clean_html(text: str) -> str:
    ...
    for pattern, replacement in GENERIC: text = pattern.sub(replacement, text)
    return strip_internal_ops_html(text)


def clean_public_js(text: str) -> str:
    text = text.replace("return heading && /verified link before starting your trial/i.test(heading.textContent || '');", "return heading && /check the trial and discount before you start/i.test(heading.textContent || '');")
    ...
    return text.replace("Test Unbounce through the verified partner route →", "Try Unbounce →")


def clean_llms(text: str) -> str:
    for old, new in (("COSHUMA's verified vendor-issued referral route", "the current vendor offer"), ("COSHUMA's verified PartnerStack customer referral URL", "the current marked vendor link"), ("verified PartnerStack route", "current vendor offer"), ("PartnerStack route", "vendor offer"), ("PartnerStack", "partner platform"), ("verified referral route", "current offer"), ("verified partner route", "current offer"), ("revenue CTA", "buyer CTA")):
...
def main() -> None:
    ...
    violations = []
    for path in html_files:
        if BANNED_CUSTOMER_COPY.search(path.read_text(encoding='utf-8')):
            violations.append(path.relative_to(ROOT).as_posix())
    if attribution_js.exists() and re.search(r'Affiliate Team message to COSHUMA|first-party reporting verifies it|Test Unbounce through the verified partner route', attribution_js.read_text(encoding='utf-8'), re.I):
        violations.append(attribution_js.relative_to(ROOT).as_posix())
    # Keep this pass self-healing rather than blocking production for wording that
    # still needs a future normalization rule. The existing public-copy test remains
    # the fail-closed deployment gate for known customer-visible leaks.
    if violations:
        print('Customer-only copy guard residual review:', ', '.join(sorted(set(violations))))
