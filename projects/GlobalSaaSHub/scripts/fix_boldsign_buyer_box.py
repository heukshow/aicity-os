...
<h3 class="font-bold">Why consider it?</h3><ul class="list-disc pl-5 space-y-1"><li>Ongoing Essential free plan with 25 envelopes per month</li><li>30-day free trial currently advertised with no credit card required; current BoldSign trial guidance says business-email signups can receive 25 eSignature documents while public email domains can receive 5</li><li>Business tier currently advertises unlimited envelopes and templates</li></ul>
...
<dl><dt class="font-bold">Free plan</dt><dd>Essential currently includes 25 envelopes/month and 2 templates at $0.</dd><dt class="font-bold">Free trial</dt><dd>BoldSign currently advertises a 30-day free trial with no credit card required. Current trial guidance says document allowances differ by email domain: business-email signups can receive 25 eSignature documents, while public email domains can receive 5.</dd></dl>
