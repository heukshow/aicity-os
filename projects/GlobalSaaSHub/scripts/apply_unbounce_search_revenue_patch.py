...
if marker not in html:
    if anchor in html:
        ...
        # The current buyer page has moved past this legacy insertion point.
        # Do not block the production build for an optional historical enrichment.
        print("Unbounce integration-fit legacy anchor absent; current page preserved without blind patch")
else:
