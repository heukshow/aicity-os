...
"""Add one high-intent partner CTA to each money-path section.

The hub should answer "which AI tool can help me make money?" without forcing a
second navigation step before a visitor can try a relevant tool. Each direct CTA
...
paths = {
    ...
    "create-content": {
        ...
        "headline": "Want to turn scripts into videos? Try Pictory.",
        "body": "Use code COSHUMA20 where eligible and confirm the discount at checkout before relying on it.",
        "cta": "Open Pictory offer →",
    },
    "sell-online": {
        ...
        "body": "Use a real offer and funnel flow to decide whether the workflow fits before committing to a paid plan.",
    ...
    "grow-traffic": {
        ...
        "body": "Test whether its content and SEO workflow fits the buyer queries you actually want to rank for.",
        "cta": "Try Writesonic →",
    },
}
