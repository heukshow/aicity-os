...
class Tests(unittest.TestCase):
 ...
 def test_corpus(self):
  r=M.audit(False,1); self.assertEqual((r["tool_count"],r["detail_pages_checked"],r["compare_pages_checked"],r["sitemap_tool_urls_checked"]),(151,151,233,151)); bad=sum(r["classification_counts"][s] for s in ("BROKEN","STALE","TYPO"))
