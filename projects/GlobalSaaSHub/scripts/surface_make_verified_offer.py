...
# - Make's first-party affiliate page rechecked 2026-09-13 repeatedly states a 35%
#   commission and describes a 12-month earning window, but one comparison paragraph
#   on that same page still says 24 months. Buyer-facing copy therefore avoids a
#   definitive commission duration and points readers to the live terms instead.
# - Program terms are not evidence of COSHUMA clicks, signups or revenue.
if MARKER in html:
