...
for(const c of configs){
 ...
 if(!t?.affiliate_verified||t.affiliate_status!=='approved_tracking')throw Error('Unverified route: '+c.id);
...
<p><strong>Pricing, free plan and trial:</strong> Check current pricing and limits before buying. Review recording permissions and your workplace policy first.</p>
